...
The `PuppyRaffle::enterRaffle` function loops through the `players` array to check for duplicates. However, the longer the `PuppyRaffle:players` array gets, the more checks will be performed for a new player. This means the gas costs for players who enter right when the raffle starts will be dramatically lower than those who enter later. Every additional address in the `players` array is an additional check the loop will have to make.
...
The gas cost for players who want to enter the raffle will drastically increase as the number of players grows.
