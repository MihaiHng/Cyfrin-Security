...
contract L1BossBridge is Ownable, Pausable, ReentrancyGuard {
     ...
     */
    // @audit-issue - High: Arbitrary transferFrom risks any approved tokens
    // @audit-issue - High: Function allows the caller to specify the from address, from which tokens are taken.
     ...
     */
    // @audit-issue - High: Signaure replay attack, he signature can be used more than once
    function sendToL1(
        uint8 v,
        bytes32 r,
        bytes32 s,
        ...
        // @audit-issue - High: Allows low-level arbitrary calls
