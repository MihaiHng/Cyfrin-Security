 ...
 */
// w@audit-issue Centralization Risk -> Using Ownable
...
contract VaultGuardians is Ownable, VaultGuardiansBase {
    ...
    constructor(
        ...
        // w@audit-issue Centralization Risk
        Ownable(msg.sender)
        VaultGuardiansBase(
            aavePool,
            uniswapV2Router,
    ...
    function updateGuardianAndDaoCut(uint256 newCut) external onlyOwner {
        ...
        // w@audit-issue Is this the correct event to emit?
