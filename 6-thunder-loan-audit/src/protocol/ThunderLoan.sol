    ...
    OracleUpgradeable
{
    ...
    // @audit-info Unused error, written in Aderyn
    ...
    // @audit-info - Should be CONSTANT or IMUTABLE
    ...
    /*//////////////////////////////////////////////////////////////
                           EXTERNAL FUNCTIONS
    //////////////////////////////////////////////////////////////*/
    // @audit-issue - Initializer can be front-run / Don't forget to initialize your contract
    ...
    function flashloan(
        ...
        // @audit-issue Low - Unchecked Return, written in Aderyn
    ...
    // @audit-issue Low - Should be marked external, written in Aderyn
    ...
    function setAllowedToken(
        ...
        external
        // @audit-issue Low - Centralization risk, written in Aderyn
        onlyOwner
        returns (AssetToken)
    {
        if (allowed) {
    ...
    // @audit-info - No natspec!!!
    // q Is this corrrect?
    // @audit-issue - High: The value of the fee should be in the same token value not in weth
    ...
    // @audit-issue Low - Centralization risk, written in Aderyn
    // @audit-issue Low - State Change Without Event, written in Aderyn
    function updateFlashLoanFee(uint256 newFee) external onlyOwner {
        if (newFee > s_feePrecision) {
            revert ThunderLoan__BadNewFee();
        }
        // @audit-issue Low - Must emit an event
    ...
    // @audit-info Empty block, written in Aderyn
